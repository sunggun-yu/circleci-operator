...
// checks if the EnvironmentVariablePair type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentVariablePair{}
...
func (o EnvironmentVariablePair) ToMap() (map[string]interface{}, error) {
